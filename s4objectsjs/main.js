...
cat.age = 5; /*Modifica el valor de una propiedad de un objeto*/

console.log(cat);

cat.breed =
  "Naranjoso"; /*Si se le asigna un valor a una propiedad que no existe, se crea la propiedad */

console.log(cat);

let emptyObject = {}; /*Objeto vacío*/

emptyObject.color = "red";

console.log(emptyObject);

cat.meow(); /*Eejectur una función de un objeto*/
